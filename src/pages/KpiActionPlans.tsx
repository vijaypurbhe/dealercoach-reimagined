...
export default function KpiActionPlansPage() {
  ...
  const realCode = dealer ? getRealCode(dealer) : null;
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="mx-auto max-w-7xl px-6 py-6">
        <Link to={`/dealers/${dealer.id}`} className="inline-flex items-center gap-1 text-xs font-medium text-muted-foreground transition-colors hover:text-foreground">
          <ArrowLeft className="h-3.5 w-3.5" /> {dealer.name}
        </Link>
        <h1 className="mt-2 text-xl font-semibold tracking-tight">KPI Improvement Action Plans</h1>
